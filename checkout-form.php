...
$query = mysqli_query($conn, "INSERT INTO orders (order_date, fullname, ad_dress, name_product, tel, grand_total) VALUES ('{$now}', '{$_POST['fullname']}', '{$_POST['ad_dress']}', '{$_POST['name_product']}', '{$_POST['tel']}', '{$_POST['grand_total']}')") or die('query failed');

...
// Fetch product names for the input field
if ($ids) {
    $query_product_names = mysqli_query($conn, "SELECT product_name FROM products WHERE id IN ($ids)");
    while ($product = mysqli_fetch_assoc($query_product_names)) {
...
<body class="bg-body-tertiary">
    ...
    <div class="container" style="margin-top: 30px;">
        ...
        <h4 class="mb-3">กรุณากรอกข้อมูลที่อยู่</h4>
        <form action="<?php echo $base_url; ?>/checkout-form.php" method="post">
            <div class="row g-5">
                <div class="col-md-6 col-lg-7">                
                    <div class="row g-3">
                        <input type="hidden" name="fullname" value="<?php echo $_SESSION['user_username']; ?>">


                        <div class="col-sm-6">
                            <label class="form-label">ที่อยู่</label>
                            <input type="text" name="ad_dress" class="form-control" placeholder="" value="">      
                        </div>
                        ...
                        <div class="col-sm-6">
                            <input type="hidden" name="name_product" class="form-control" placeholder="" value="<?php echo $productNamesString; ?>" readonly>      
                        </div>

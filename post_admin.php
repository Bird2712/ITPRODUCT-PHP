                    ...
                    <?php while ($post = mysqli_fetch_assoc($query)): ?>
                        <tr>
                            ...
                            <td><?php echo $post['post_name']; ?>
                                ...
                                <td>
                            <a role="button" href="<?php echo $base_url; ?>/post_admin.php?id=<?php echo $post['id']; ?>" class="btn btn-outline-dark"><i class="fa-regular fa-pen-to-square me-1"></i>Edit</a>
                            <a onclick="return confirm('Are you sure ?');" role="button" href="<?php echo $base_url; ?>/post-delete.php?id=<?php echo $post['id']; ?>" class="btn btn-outline-danger"><i class="fa-solid fa-trash me-1"></i>Delete</a>
                            </td>
                        </tr>
                <?php endwhile; ?>
                <?php else: ?>

        ...
        <div class="row g-5">
            <div class="col-md-8 col-sm-12">
                <form action="<?php echo $base_url; ?>/product-details.php" method="get">
                    ...
                    <a href="http://localhost/shoppingcart/product-listlie.php" class="btn btn-secondary"><i class="fa-solid fa-rotate-left me-1"></i> กลับ</a>
                    <a href="http://localhost/shoppingcart/login/register2.php" class="btn btn-primary"></i> ลงทะเบียน</a>
                </form>
            </div>
        </div>
    </div>
